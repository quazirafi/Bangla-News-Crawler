        ...
        <form style="margin-left: 500px" action="UpdateCorpus" method="post">
            ...
            <div class="form-white-background">
                ...
                <div class="multiselect" >
                    ...
                    <div id="checkboxes">
                        <label>
                            <input type="checkbox" value="prothomAlo" name="newspaperName" />Prothom Alo
                        </label>   
                        <label>
                            <input type="checkbox" value="kalerKantho" name="newspaperName" />Kaler Kantho
                        </label>
                        <label>
                            <input type="checkbox" value="manabZamin" name="newspaperName" />Manab Zamin
                        </label>   
                        <label>
                            <input type="checkbox" value="bdnews24" name="newspaperName" />Bdnews24
                        </label>
                        <label>
                            <input type="checkbox" value="banglanews24" name="newspaperName" />Banglanews24
                        </label>   
                        <label>
                            <input type="checkbox" value="ittefaq" name="newspaperName" />Ittefaq
                        </label>
                    </div>
                </div>
